...
<script>
    ...
    const myChart1 = new Chart(ctx1, {
        type: 'line',
        data: {
            labels: [<?php foreach ($pertahun as $data) : ?> '<?php echo $data->year; ?>',
                <?php endforeach; ?>
            ],
            datasets: [{
                label: 'Jumlah Dokumen',

                data: [<?php foreach ($pertahun as $data) : ?> '<?php echo $data->jumlah_doc; ?>',
                    <?php endforeach; ?>
                ],
    ...
    const myChart2 = new Chart(ctx2, {
        ...
        data: {
            labels: [
                <?php foreach ($prodi as $data) : ?> '<?php echo $data->prodi; ?>',
                <?php endforeach; ?>
            ],
            datasets: [{
                    label: 'Jumlah Dokumen',
                    data: [
                        <?php foreach ($prodi as $data) : ?> '<?php echo $data->jumlah_doc; ?>',
                        <?php endforeach; ?>
                    ],
                ...
                },
                {
                    label: 'Jumlah Sitasi',
                    data: [
                        <?php foreach ($prodi as $data) : ?> '<?php echo $data->jumlah_sitasi; ?>',
                        <?php endforeach; ?>
                    ],
    ...
    const myChart3 = new Chart(ctx3, {
        ...
        data: {
            labels: [
                <?php foreach ($dosen as $data) : ?> '<?php echo $data->nama_dosen; ?>',
                <?php endforeach; ?>
            ],
            datasets: [{
                    label: 'Jumlah Dokumen',
                    data: [<?php foreach ($dosen as $data) : ?> '<?php echo $data->jumlah_doc; ?>',
                        <?php endforeach; ?>
                    ],
                ...
                {
                    label: 'Jumlah Sitasi',
                    data: [<?php foreach ($dosen as $data) : ?> '<?php echo $data->jumlah_sitasi; ?>',
                        <?php endforeach; ?>
                    ],
